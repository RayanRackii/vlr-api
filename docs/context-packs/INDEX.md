...
Use for: GlobalMaintenanceTemplate, MaintenancePlan, PlanTask, PmocEngineJob, WorkOrder, WorkOrderTask, Biblioteca Rolvix, Gerar OS. Phase 1 spec: [`docs/plans/active/2026-09-18-pmoc-os-phase1.md`](../plans/active/2026-09-18-pmoc-os-phase1.md) (approved). Slice 1 is domain + migrations A/B only.
