...
- [ ] Provisioning P1/O2: seed idempotente de tipos exemplo no create **e** no update ao adicionar família (`spaces`/`electrical`/`goods`; `generic` sem seed). Spec [`docs/plans/active/2026-09-04-asset-registry-category-provisioning.md`](./docs/plans/active/2026-09-04-asset-registry-category-provisioning.md). Sem CRUD PMOC/OS. **Bloqueado** até decisão A/B (`pmoc` + só `generic`).
