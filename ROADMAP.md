...
| Data | Mudança |
|---|---|
| 2026-09-06 | **Fix (API):** Complete × Cancel exclusive-winner — `ReservationLocks` `FOR UPDATE` then (Cancel only) `RentalAssetLocks` ascending. Dual success closed. Phase B still blocked; PROD timestamps still **INSUFFICIENT_EVIDENCE**. |
