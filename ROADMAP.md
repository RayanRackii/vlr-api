...
| Data | Mudança |
|---|---|
| 2026-09-19 | **Em curso (API, Phase 3 Slice 1):** final PMOC scheduling foundation — `IntervalDays` + `FirstDueDate`, `PmocDueCalculator`, fail-closed `PmocEngineJob`, destructive forward migration file **not applied**. Dual Calendar/Interval VOID. H6/H7 = NO. Spec `docs/plans/active/2026-09-19-pmoc-os-phase3.md`. Branch `feat/pmoc-os-phase3-final-scheduling-foundation`. |
