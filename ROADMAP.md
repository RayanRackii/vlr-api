...
| 2026-09-02 | **Fix:** Bearer default is PolicyScheme (`iss=platform.b2c` → `CustomerJwt`, else `Supabase`); TenantProvider reads only authenticated identities so catalog GQF/gate get the customer tenant. |
