...
| Data | Mudança |
|---|---|
| 2026-09-19 | **Em curso (API, Phase 2 Slice 1):** derived PMOC coverage read model `GET /api/maintenance-plans/{id}/coverage`. Sem migration. Sem Hangfire/generator change. H6/H7 = NO. Spec `docs/plans/active/2026-09-19-pmoc-os-phase2.md`. Branch `feat/pmoc-os-phase2-coverage-api`. |
